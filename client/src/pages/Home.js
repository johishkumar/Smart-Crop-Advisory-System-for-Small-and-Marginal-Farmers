...
const Home = () => {
  const features = [
    ...
    {
      icon: Camera,
      title: 'Image Analysis & Disease Detection',
      description: 'Upload crop images for instant pest and disease detection with AI-powered computer vision technology.',
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'The image analysis feature is incredible. I can quickly identify diseases and provide better recommendations to farmers.',
      rating: 5
    },
    {
      name: 'Amit Patel',
            ...
            {[
              {
                ...
                description: 'Enter soil conditions, weather data, and location information'
              },
              {
                step: '02',
                title: 'AI Analysis',
                description: 'Our ML models analyze your data and market conditions'
              },
              {
                step: '03',
                title: 'Get Recommendations',
                description: 'Receive personalized crop suggestions with confidence scores'
              }
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Join thousands of satisfied farmers who trust CropAI
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="mt-4 text-gray-400">
                Intelligent crop recommendation platform for modern farming.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li><Link to="/image-analysis" className="text-gray-400 hover:text-white">Image Analysis</Link></li>
          ...
          <div className="mt-8 border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400">
              © 2024 CropAI. All rights reserved. Built for SIH Hackathon.
            </p>
          </div>
        </div>
      </footer>
